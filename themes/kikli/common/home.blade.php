...
@section('body')
    ...
    <div class="container" id="home-default">
	    <div class="mb-xl card">
	    	<h3 class="card-title">{{ trans('entities.shelves') }}</h3>
			<div class="px-m">
	        	@include('partials.entity-list', ['entities' => $shelves, 'style' => 'compact'])
        	</div>
    	</div>
            ...
            <div>
                @if(count($draftPages) > 0)
                    <div id="recent-drafts" class="card mb-xl">
                        ...
                        <div class="px-m">
                            @include('partials.entity-list', ['entities' => $draftPages, 'style' => 'compact','showPath' => true])
                        </div>
                    </div>
                @endif
