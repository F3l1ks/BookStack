...
return [
    ...
    'shelf' => 'Regal',
    'shelves' => 'Regale',
    'x_shelves' => '{0} :count Regale|{1} :count Regal|[2,*] :count Regale',
    ...
    'book' => 'Buch',
    'books' => 'Bücher',
    'x_books' => '{0} :count Bücher|{1} :count Buch|[2,*] :count Bücher',
    ...
    'page' => 'Seite',
    'pages' => 'Seiten',
    'x_pages' => '{0} :count Seiten|{1} :count Seite|[2,*] :count Seiten',
